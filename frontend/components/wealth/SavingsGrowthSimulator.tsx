...
export default function SavingsGrowthSimulator({ currentSavings }: SavingsGrowthSimulatorProps) {
  ...
  return (
    <div className="relative overflow-hidden rounded-3xl border border-slate-700/80 bg-gradient-to-br from-slate-900/95 via-slate-900/85 to-slate-950/95 p-6 md:p-8 shadow-2xl backdrop-blur-xl transition-all duration-300 stage-card-lift">
      ...
      <div className="pointer-events-none absolute -left-12 -bottom-12 h-52 w-52 rounded-full bg-emerald-500/15 blur-3xl" />

      {/* Header */}
      <div className="flex flex-wrap items-center justify-between gap-4 mb-6 border-b border-slate-800/80 pb-4">
        <div className="flex items-center gap-3">
          <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-gradient-to-br from-emerald-500/25 to-teal-500/15 border border-emerald-500/40 shadow-lg">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 mt-0.5">Forecast the exponential power of compounding interest</p>
          </div>
        </div>
